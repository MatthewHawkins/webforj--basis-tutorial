...
import org.example.renderer.CountryRenderer;
...
public class HomeView extends Composite<Div> {
  ...
  private void buildTable() {
    ...
    table.addColumn("CountryName", Customer::getCountry).setHidden(true);
    table.addColumn("CountryCode", (c) -> c.getCountry().getCode()).setHidden(true);
    table.addColumn("Country", new CountryRenderer());
